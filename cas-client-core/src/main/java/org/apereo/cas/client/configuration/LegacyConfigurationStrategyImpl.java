...
/**
 * Replicates the original behavior by checking the {@link org.apereo.cas.client.configuration.WebXmlConfigurationStrategyImpl} first, and then
 * the {@link org.apereo.cas.client.configuration.JndiConfigurationStrategyImpl} before using the <code>defaultValue</code>.
 *
