...
public enum ConfigurationStrategyName {
    ...
    /**
     * Static helper method that will resolve a simple string to either an enum value or a {@link org.apereo.cas.client.configuration.ConfigurationStrategy} class.
     *
