...
public class Cas20ProxyReceivingTicketValidationFilter extends AbstractTicketValidationFilter {
    ...
    protected void initInternal(final FilterConfig filterConfig) throws ServletException {
        setProxyReceptorUrl(getString(ConfigurationKey.PROXY_RECEPTOR_URL, null));

        final Class<? extends ProxyGrantingTicketStorage> proxyGrantingTicketStorageClass = getClass(ConfigurationKey.PROXY_GRANTING_TICKET_STORAGE_CLASS, null);
        ...
        if (proxyGrantingTicketStorageClass != null) {
            ...
            if (this.proxyGrantingTicketStorage instanceof AbstractEncryptedProxyGrantingTicketStorageImpl) {
                ...
                final String cipherAlgorithm = getString(ConfigurationKey.CIPHER_ALGORITHM,
                        AbstractEncryptedProxyGrantingTicketStorageImpl.DEFAULT_ENCRYPTION_ALGORITHM);
                final String secretKey = getString(ConfigurationKey.SECRET_KEY, null);
        ...
        this.millisBetweenCleanUps = getInt(ConfigurationKey.MILLIS_BETWEEN_CLEAN_UPS, DEFAULT_MILLIS_BETWEEN_CLEANUPS);
    ...
    protected final TicketValidator getTicketValidator(final FilterConfig filterConfig) {
        final boolean allowAnyProxy = getBoolean(ConfigurationKey.ACCEPT_ANY_PROXY, false);
        final String allowedProxyChains = getString(ConfigurationKey.ALLOWED_PROXY_CHAINS, null);
        final String casServerUrlPrefix = getString(ConfigurationKey.CAS_SERVER_URL_PREFIX, null);
        final Class<? extends Cas20ServiceTicketValidator> ticketValidatorClass = getClass(ConfigurationKey.TICKET_VALIDATOR_CLASS, null);
        ...
        validator.setProxyCallbackUrl(getString(ConfigurationKey.PROXY_CALLBACK_URL, null));
        ...
        validator.setProxyRetriever(new Cas20ProxyRetriever(casServerUrlPrefix, getString(ConfigurationKey.ENCODING, null), factory));
