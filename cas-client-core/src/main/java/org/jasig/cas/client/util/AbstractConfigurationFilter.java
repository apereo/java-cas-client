...
public abstract class AbstractConfigurationFilter implements Filter {
    ...
    protected final boolean getBoolean(final ConfigurationKey configurationKey, final boolean defaultValue) {
        return this.configurationStrategy.getBoolean(configurationKey, defaultValue);
    }

    protected final String getString(final ConfigurationKey configurationKey, final String defaultValue) {
        return this.configurationStrategy.getString(configurationKey, defaultValue);
    }

    protected final long getLong(final ConfigurationKey configurationKey, final long defaultValue) {
        return this.configurationStrategy.getLong(configurationKey, defaultValue);
    }

    protected final int getInt(final ConfigurationKey configurationKey, final int defaultValue) {
        return this.configurationStrategy.getInt(configurationKey, defaultValue);
    }

    protected final <T> Class<T> getClass(final ConfigurationKey configurationKey, final Class<T> defaultValue) {
        return this.configurationStrategy.getClass(configurationKey, defaultValue);
    }
