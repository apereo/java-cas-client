...
public final class ConfigurationKeyTests {
    ...
    public void gettersWithNoDefaultValue() {
        final var name = "name";
        final var configurationKey = new ConfigurationKey<Boolean>(name);
    ...
    public void gettersWithDefaultValue() {
        final var name = "name";
        final var defaultValue = Boolean.TRUE;
        final var configurationKey = new ConfigurationKey<>(name, defaultValue);
        assertEquals(name, configurationKey.getName());
