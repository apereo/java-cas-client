...
public final class Saml11TicketValidatorTests extends AbstractTicketValidatorTests {
    ...
    public void testCompatibilityValidationFailedResponse() throws UnsupportedEncodingException {
        final var RESPONSE = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><SOAP-ENV:Envelope\n"
    ...
    public void testCompatibilityValidationSuccessWithNoAttributes() throws UnsupportedEncodingException {
        final var startTime = currentTimeRangeStart();
        final var endTime = currentTimeRangeEnd();
        final var now = new Date();
        final var RESPONSE = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><Response xmlns=\"urn:oasis:names:tc:SAML:1.0:protocol\" xmlns:saml=\"urn:oasis:names:tc:SAML:1.0:assertion\" xmlns:samlp=\"urn:oasis:names:tc:SAML:1.0:protocol\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" IssueInstant=\""
        ...
        server.content = RESPONSE.getBytes(server.encoding);
        try {
            final var a = this.validator.validate("test", "test");
    ...
    public void testCompatibilityValidationSuccessInsideTolerance() throws UnsupportedEncodingException {
        final var addedTime = CLIENT_TOLERANCE;
        final var startTime = Date.from(currentTimeRangeStart().toInstant().plusMillis(addedTime));
        final var endTime = Date.from(currentTimeRangeEnd().toInstant().plusMillis(addedTime));
        final var now = Date.from(ZonedDateTime.now(ZoneOffset.UTC).toInstant().plusMillis(addedTime));
        final var RESPONSE = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><Response xmlns=\"urn:oasis:names:tc:SAML:1.0:protocol\" xmlns:saml=\"urn:oasis:names:tc:SAML:1.0:assertion\" xmlns:samlp=\"urn:oasis:names:tc:SAML:1.0:protocol\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" IssueInstant=\""
                             + SamlUtils.formatForUtcTime(now)
                             + "\" MajorVersion=\"1\" MinorVersion=\"1\" Recipient=\"test\" ResponseID=\"_e1e2124c08ab456eab0bbab3e1c0c433\"><Status><StatusCode Value=\"samlp:Success\"></StatusCode></Status><Assertion xmlns=\"urn:oasis:names:tc:SAML:1.0:assertion\" AssertionID=\"_d2fd0d6e4da6a6d7d2ba5274ab570d5c\" IssueInstant=\""
                             + SamlUtils.formatForUtcTime(now)
    ...
    public void testCompatibilityValidationFailedOutsideTolerance() throws UnsupportedEncodingException {
        final var addedTime = 2 * CLIENT_TOLERANCE;
        final var startTime = Date.from(currentTimeRangeStart().toInstant().plusMillis(addedTime));
        final var endTime = Date.from(currentTimeRangeEnd().toInstant().plusMillis(addedTime));
        final var now = Date.from(ZonedDateTime.now(ZoneOffset.UTC).toInstant().plusMillis(addedTime));
        final var RESPONSE = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><Response xmlns=\"urn:oasis:names:tc:SAML:1.0:protocol\" xmlns:saml=\"urn:oasis:names:tc:SAML:1.0:assertion\" xmlns:samlp=\"urn:oasis:names:tc:SAML:1.0:protocol\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" IssueInstant=\""
    ...
    public void openSaml2GeneratedResponse() throws UnsupportedEncodingException {
        ...
        final var response = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap11:Envelope xmlns:soap11=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap11:Body>"
    ...
    private static ZonedDateTime currentTimeRangeStart() {
        return ZonedDateTime.now(ZoneOffset.UTC).minus(SERVER_TOLERANCE, ChronoUnit.MILLIS);
    }

    private static ZonedDateTime currentTimeRangeEnd() {
